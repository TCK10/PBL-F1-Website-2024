  ...
  fetch('questions.json')
    ...
    .then(data => {
      ...
      if (!selectedCategory) {
        ...
        allQuestions = data[selectedCategory].questions;
      }
      ...
      // Check if we have any questions matching the criteria
      ...
      questions = allQuestions.slice(0, numQuestions.value);
      
      // Check if we have enough questions
      if (questions.length < numQuestions.value) {
        alert(`Only ${questions.length} questions available with the selected criteria`);
      }
...
const showQuestion = (question) => {
  ...
  questionText.className = `question ${difficultyClass}`;
